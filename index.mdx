...
import tutorialsIcon from '@site/assets/site/icons/tutorials.svg';
import onboardingIcon from '@site/assets/site/icons/onboarding.svg';
import resourcesIcon from '@site/assets/site/icons/resources.svg';
