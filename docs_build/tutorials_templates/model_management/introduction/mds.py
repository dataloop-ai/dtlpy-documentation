def func1():
    ...
    Models can be derived from ready-to-go packages from open source algorithms. Models can also be created from pre-trained models for fine-tuning or transfer learning.
