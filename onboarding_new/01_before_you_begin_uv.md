...
### uv vs pip (brief comparison)

| Feature                       | pip                            | uv                             |
|-------------------------------|--------------------------------|--------------------------------|
| Speed                         | Slow (Python)                  | 🔥 Extremely fast (Rust)       |
| Dependency resolution         | Basic                          | ✅ Deterministic & reliable    |
| Virtual env creation          | ❌ Separate (python -m venv)   | ✅ Built-in                    |
| Lockfile                      | ❌ No                          | ✅ Yes (uv.lock)              |
| Python installs               | ❌ No                          | ✅ Yes                         |
