...
```python
dataset_training_name = "training-data-3"
dataset_training_update_name = "training-data-3-update"

dataset_validation_name = "validation-data-3"
dataset_test_name = "test-data-3"
```
...
cloned_dataset = dataset.clone(
    clone_name=dataset_validation_name   
)
```
...
# Update dataset
dataset.name = dataset_training_update_name
dataset.update()
```
